...
<div class="mb-3">
    ...
    <input type="text" name="agama" class="form-control <?php $__errorArgs = ['agama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
           value="<?php echo e(old('agama', $mahasiswa->agama ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('alamat', $mahasiswa->alamat ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
           value="<?php echo e(old('telepon', $mahasiswa->telepon ?? '')); ?>">
...
<div class="mb-3">
    ...
    <?php if(!empty($mahasiswa?->foto)): ?>
        <div class="mb-2">
            <img src="<?php echo e(asset('storage/' . $mahasiswa->foto)); ?>" width="120" alt="Foto Saat Ini">
        </div>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\laravel-mahasiswa\resources\views/mahasiswa/form.blade.php ENDPATH**/ ?>